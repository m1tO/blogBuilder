		...
		<div id="container">
            ...
            <div id="main">
            	<div id="content">
						...
						//Passaggio variabili da conservare
						$idPost=$_POST['idPost'];
						$idAutore=$_POST['idAutore'];
						$nomeFile=$_POST['nomeFile'];
						
						//Autore del post originale
						$autoreOrg="SELECT nome, cognome FROM utenti WHERE (id='$idAutore')";
						$resultAutoreOrg=mysql_query($autoreOrg, $myconn) or die("Errore query autore originale");
						$rigaAutoreOrg=mysql_fetch_array($resultAutoreOrg);
						
						$cognome=$rigaAutoreOrg['cognome'];
						$nome=$rigaAutoreOrg['nome'];
						...
						$post1="UPDATE post SET titolo='$titolo', testo='$testo', percorso='$percorso' WHERE id='$idPost'";
						$resultPost1 = mysql_query($post1, $myconn) or die("Errore aggiornamento post");
						
						//Cancellazione vecchie sottocategorie del post
						...
						$post="SELECT id, titolo, testo, DATE_FORMAT(dataPub, '%d') AS giorno, DATE_FORMAT(dataPub, '%m') AS mese, idUtenti FROM post WHERE (titolo='$titolo')";
...
/*Fine contenuto file*/
					...
					<h2>Aggiornamento avvenuto con successo!</h2>
                    <?php 
